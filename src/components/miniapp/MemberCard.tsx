    ...
    <section className="animate-fade-in overflow-hidden rounded-3xl shadow-card">
      <div className="gradient-card relative px-5 pb-5 pt-5 text-white">
        ...
        <div className="flex items-center gap-3.5">
          <img
            src={member.picture_url || 'https://placehold.co/96x96/06C755/ffffff?text=' + encodeURIComponent(displayName.charAt(0))}
            alt={displayName}
      ...
      <div className="bg-white px-5 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5 text-xs font-medium text-slate-500">
            <TrendingUp size={14} />
            <span>ไปยัง {tier.next_tier_name || 'ระดับสูงสุด'}</span>
          </div>
